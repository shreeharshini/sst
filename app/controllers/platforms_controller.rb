class PlatformsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @platform.update(platform_params)
        format.html { redirect_to accessdetails_loginpage_index_path, notice: 'Platform was successfully updated.' }
  ...
  private
    ...
    def platform_params
      params.require(:platform).permit(:abbrev, :name, :created_by, :updated_by)
    end
end
