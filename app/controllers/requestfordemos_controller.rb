class RequestfordemosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @requestfordemo.save
        ...
        format.html { redirect_to root_url, notice: 'Request for demo was successfully send.' }
  ...
  def update
    respond_to do |format|
      if @requestfordemo.update(requestfordemo_params)
        format.html { redirect_to @requestfordemo, notice: 'Request for demo was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to requestfordemos_url, notice: 'Request for demo was successfully destroyed.' }
