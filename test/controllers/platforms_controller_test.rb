...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { abbrev: @platform.abbrev, created_by: @platform.created_by, name: @platform.name, updated_by: @platform.updated_by } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { abbrev: @platform.abbrev, created_by: @platform.created_by, name: @platform.name, updated_by: @platform.updated_by } }
